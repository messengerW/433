...
public class Fragment2_Child3 extends Fragment {

    private View view;
    public RecyclerView mCollectRecyclerView;
    private ArrayList<Fragment2_Child3_RankItem> ItemArrayList = new ArrayList<Fragment2_Child3_RankItem>();
    private Fragment2_Child3_RankAdapter mCollectRecyclerAdapter;
    ...
    private void initRankItem() {
        ...
        for (int i = 1; i <= 18; i++) {
            Fragment2_Child3_RankItem RankItem = new Fragment2_Child3_RankItem();
    ...
    private void initRecyclerView() {
        ...
        //创建adapter
        mCollectRecyclerAdapter = new Fragment2_Child3_RankAdapter(mActivity, ItemArrayList);
        ...
        mCollectRecyclerAdapter.setOnItemClickListener(new Fragment2_Child3_RankAdapter.OnItemClickListener() {
            @Override
