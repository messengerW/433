...
public class F2_C1_GameDao {
     ...
     * @return
     */
    public ArrayList<F2_C1_GameBean> getGameList() {

        ArrayList<F2_C1_GameBean> rankList = new ArrayList<F2_C1_GameBean>();
        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                do {
                    ...
                    //  实例化一个bean，也就是VO
                    F2_C1_GameBean bean = new F2_C1_GameBean();
                    ...
                    String score1 = cursor.getString(cursor.getColumnIndex("score1"));
                    ...
                    bean.setTeam1(name1);
                    bean.setTeam2(name2);
                    bean.setScore1(score1);
                    bean.setScore2(score2);
