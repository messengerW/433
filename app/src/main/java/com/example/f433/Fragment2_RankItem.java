...
public class Fragment2_RankItem implements Serializable {
    ...
    public Fragment2_RankItem() {
    }

    public Fragment2_RankItem(String rank, String imgPath, String name, String turn, String num1,
